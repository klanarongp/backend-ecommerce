...
exports.createBillingRecord = (req, res) => {
    ...
    connection.query(sql, [email, promotion_id, amount, vat, price, total_price, imgPath], (err, result) => {
        ...
        res.status(201).json({ message: 'Billing record created successfully!', data: { email, promotion_id, amount, vat, price, total_price, img_bill: imgPath ? `http://localhost:3000/${imgPath}` : null } }); // สร้าง URL รูปภาพ
    });
};
